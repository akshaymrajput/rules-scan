...
module.exports = [
  ...
  },
  {
    conditions: {
      ...
      galleryItems: [
        ...
        ".product-single__photos .product__photo.media--hidden:first img",
      ],
      priceElements: [
        ".product__page [data-price-wrapper] [data-product-price]",
      ],
    ...
    data: {
      ...
      jQuery(
        ".product-single__photos .product__photo img[src]:first"
      ).attr("src") ||
      jQuery('meta[property="og:image"]').attr("content");
    if ($img) {
      $img = $img.indexOf("http") == -1 ? "https:" + $img : $img;
  ...
  },
  {
    conditions: {
      titleElement: ["h1.product-title:first"],
      galleryItems: [
        ".product-main-slide .swiper-slide.swiper-slide-active img",
      ],
      priceElements: [".product-price .price:first"],
      addButton: [".product-summary button.add-to-cart-button"],
    },
    data: {
      productTitle: `
      jQuery("h1.product-title:first").text().trim();
      ...
      $img =
        jQuery(
          ".product-main-slide .swiper-slide.swiper-slide-active [data-zoom]"
        ).attr("data-zoom") ||
        jQuery(".product-main-slide .swiper-slide.swiper-slide-active img[src]").attr(
          "src"
        ) ||
        jQuery('meta[property="og:image:secure_url"]').attr("content") ||
        jQuery('meta[property="og:image"]').attr("content");
      if ($img) {
        ...
        $img = $img.split("?")[0];
          ...
          `,
      itemImages: `
      if (jQuery(".product-main-slide .swiper-slide").length > 0) {
        $arr = [];
        jQuery(".product-main-slide .swiper-slide").each(function (index) {
          $img =
            jQuery(this).find("[data-zoom]").attr("data-zoom") ||
            jQuery(this).find("img[src]").attr("src");
          if ($img) {
      ...
      $pr = jQuery(".product-price .price:first").text().trim();
      $pr =
        $cr && $pr
          ? $cr + $pr.replace(/[^,.\\d]/g, "").replace(/^[,.]+|[,.]+$/g, "")
          : $pr;
      ...
      $pr =
        jQuery(".product-price s.regular-price:first").text().trim() ||
        jQuery(".product-price .price:first").text().trim();
      $pr =
        $cr && $pr
          ? $cr + $pr.replace(/[^,.\\d]/g, "").replace(/^[,.]+|[,.]+$/g, "")
          : $pr;
          `,
      stockStatus: `
      jQuery(".product-summary button.add-to-cart-button").is(":disabled") ||
        jQuery(".product-summary button.add-to-cart-button")
          .closest("form.product-buy")
          .hasClass("disabled") ||
        jQuery(".template-404:visible").length > 0;
          `,
    },
  ...
  {
    conditions: {
      titleElement: ['#product-description [itemprop="name"]'],
      galleryItems: [
        "#product-photos .main-product-image img",
        ".product-image-container .image-slide.carousel-cell.is-selected img",
      ],
      priceElements: ["#product-price:visible .product-price"],
      addButton: ["#product-add .AddtoCart"],
    },
    data: {
      productTitle: `
      jQuery('#product-description [itemprop="name"]').text().trim();
          `,
      mainImage: `
      $img =
        jQuery("#product-photos .main-product-image .zoomImg").attr("src") ||
        jQuery("#product-photos .main-product-image img:first").attr("src") ||
        jQuery(
          ".product-image-container .image-slide.carousel-cell.is-selected [data-zoom-src]"
        ).attr("data-zoom-src") ||
        jQuery(
          ".product-image-container .image-slide.carousel-cell.is-selected img[src]"
        ).attr("src") ||
        jQuery('meta[property="og:image"]').attr("content");
      if ($img) {
        $img = $img.indexOf("http") == -1 ? "https:" + $img : $img;
      ...
      if (jQuery(".product-image-container .image-slide.carousel-cell").length > 0) {
        ...
        jQuery(".product-image-container .image-slide.carousel-cell").each(function (
          ...
          $img =
            jQuery(this).find("[data-zoom-src]").attr("data-zoom-src") ||
            jQuery(this).find("img[src]").attr("src") ||
            jQuery('meta[property="og:image"]').attr("content");
          if ($img) {
            $img = $img.indexOf("http") == -1 ? "https:" + $img : $img;
        ...
        $arr;
      } else if (jQuery("#thumbnail-gallery .slide").length > 0) {
        $arr = [];
        jQuery("#thumbnail-gallery .slide").each(function (index) {
          $img =
            jQuery(this).find("a").attr("href") ||
            jQuery(this).find("img").attr("src") ||
            jQuery('meta[property="og:image"]').attr("content");
        ...
        $arr;
          ...
          `,
      productPrice: `
      $pr = jQuery("#product-price:visible .product-price").text().trim();
      ...
      productOriginalPrice: `
      $pr =
        jQuery("#product-price:visible .was").text().trim() ||
        jQuery("#product-price:visible .product-price").text().trim();
      ...
      $pr =
        $cr && $pr
          ...
          `,
      stockStatus: `
      jQuery("#product-add .AddtoCart").is(":disabled");
          `,
    },
  },
  {
    conditions: {
      titleElement: [".product-title h1:first"],
      galleryItems: [".product-media-images .swiper-slide img"],
      priceElements: [".product-details-price-snippet [data-product-price]"],
      addButton: [".product-details-form-wrapper [data-add-to-cart]"],
    },
    data: {
      productTitle: `
      jQuery(".product-title h1:first").text().trim();
          `,
      mainImage: `
      $img =
        jQuery(".product-media-images .swiper-slide.swiper-slide-active img[data-raw-src]").attr(
          "data-raw-src"
        ) ||
        jQuery(".product-media-images .swiper-slide.swiper-slide-active img[src]").attr(
          "src"
        ) ||
        jQuery(".product-media-images .swiper-slide:first img[src]").attr(
          "src"
        ) ||
        jQuery('meta[property="og:image:secure_url"]').attr("content") ||
        jQuery('meta[property="og:image"]').attr("content");
      if ($img) {
        ...
        $img = $img.split("?")[0];
          ...
          `,
      itemImages: `
      if (jQuery(".product-media-images .swiper-slide").length > 0) {
        $arr = [];
        jQuery(".product-media-images .swiper-slide").each(function (index) {
          $img =
            jQuery(this).find("[data-raw-src]").attr("data-raw-src") ||
            jQuery(this).find("img").attr("src");
          if ($img) {
            $img = $img.indexOf("http") == -1 ? "https:" + $img : $img;
            $img = $img.split("?")[0];
      ...
      $pr = jQuery(".product-details-price-snippet [data-product-price]")
        .text()
        .trim();
      $pr =
        $cr && $pr
      ...
      $pr =
        jQuery(".product-details-price-snippet [data-product-compare-at-price]")
          .text()
          .trim() ||
        jQuery(".product-details-price-snippet [data-product-price]").text().trim();
      $pr =
        $cr && $pr
          ? $cr + $pr.replace(/[^,.\\d]/g, "").replace(/^[,.]+|[,.]+$/g, "")
          : $pr;
          `,
      stockStatus: `
      jQuery(".product-details-form-wrapper [data-add-to-cart]").is(":disabled") ||
        jQuery(
          ".product-details-form-wrapper [data-variant-stock-display-out-of-stock]"
        ).is(":visible") ||
        jQuery("#404-not-found").length > 0;
          `,
    },
  },
];
